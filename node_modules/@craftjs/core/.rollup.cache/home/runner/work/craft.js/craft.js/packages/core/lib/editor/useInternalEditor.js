import { useCollector, wrapConnectorHooks, ERROR_USE_EDITOR_OUTSIDE_OF_EDITOR_CONTEXT, } from '@craftjs/utils';
...
export function useInternalEditor(collector) {
    ...
    const connectors = useMemo(() => connectorsUsage && wrapConnectorHooks(connectorsUsage.connectors), [connectorsUsage]);
    return {
        ...collected,
        connectors,
        inContext: !!store,
