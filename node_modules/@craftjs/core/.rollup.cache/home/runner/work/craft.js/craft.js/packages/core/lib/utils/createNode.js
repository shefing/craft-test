...
export function createNode(newNode, normalize) {
    ...
    if (userComponentConfig) {
        ...
        if (userComponentConfig.isCanvas !== undefined &&
        ...
        if (userComponentConfig.related) {
            ...
            Object.keys(userComponentConfig.related).forEach((comp) => {
                node.related[comp] = (props) => React.createElement(NodeProvider, relatedNodeContext, React.createElement(userComponentConfig.related[comp], props));
            });
        }
    }
    return node;
